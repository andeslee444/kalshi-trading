"""Oracle NBA trading domain models.

Ported from sportsmarket/oracle/models.py with adaptations for kalshi-trading.
"""
...
class OraclePosition:
    """Tracked position in the Oracle risk ledger."""
    book: Book
    ticker: str
    side: str
    contracts: int
    ...
    def exposure_cents(self) -> int:
        return self.contracts * self.entry_price_cents
    ...
    @classmethod
    def from_dict(cls, d: dict) -> OraclePosition:
        return cls(
            book=Book[d["book"]],
            ticker=d["ticker"],
            side=d["side"],
