...
**Current focus:** Phase 1: Feedback Loop
...
- calibration.json is empty -- all models on hardcoded defaults until Phase 1 completes
- Zero settlement reconciliation done -- no ground truth exists yet
